...
class Product(models.Model):
    ...
    imar = models.CharField(max_length=200, db_index=True,default='İnformation')
    adaNo = models.CharField(max_length=200, db_index=True,default='İnformation')
    parselNo = models.CharField(max_length=200, db_index=True,default='İnformation')
    paftaNo = models.CharField(max_length=200, db_index=True,default='İnformation')
    emsal = models.CharField(max_length=200, db_index=True,default='İnformation')
    gabari = models.CharField(max_length=200, db_index=True,default='İnformation')
    elektrik = models.CharField(max_length=200, db_index=True,default='İnformation')
    su = models.CharField(max_length=200, db_index=True,default='Su')
    ...
    def get_absolute_url(self):
        return reverse('land:product_detail', args=[self.slug, self.id])
